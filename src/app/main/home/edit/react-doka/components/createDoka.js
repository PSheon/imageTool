...
var getOptionsFromProps = function getOptionsFromProps(props) {
    return Object.keys(props).filter(function (prop) {
        return allowedProps.find(function (key) {
...
var updateDoka = exports.updateDoka = function updateDoka(instance, props) {
    return instance.setOptions(getOptionsFromProps(props));
};
...
var createDoka = exports.createDoka = function createDoka(component, root) {
    ...
    var params = [getOptionsFromProps(props)];
